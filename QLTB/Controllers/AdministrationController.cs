...
namespace QLTB.Controllers
{
    ...
    public class AdministrationController : Controller
    {
        ...
        public AdministrationController(RoleManager<IdentityRole> roleManager, UserManager<ApplicationUser> userManager, IUnitOfWork unitOfWork)
        {
        ...
        public async Task<IActionResult> ManageUserClaims(string userId)
        {
            ...
            if (user == null)
            {
                ViewBag.Message = $"User with id = {userId} cannot be foound";
        ...
        public async Task<IActionResult> ManageUserClaims(UserClaimsViewModel model, string userId)
        {
            ...
            if (user == null)
            {
                ViewBag.Message = $"User with id = {model.UserId} cannot be foound";
                return View("NotFound");
            }
            ViewBag.userName = user.UserName;
        ...
        public async Task<IActionResult> ManageUserRoles(string userId)
        {
            ...
            if (user == null)
            {
                ViewBag.ErrorMessage = $"User with id = {userId} cannot be foound";
                return View("NotFound");
            }
            ViewBag.userName = user.UserName;
        ...
        {
            var users = userManager.Users.Include(x => x.ChiNhanh);
            return View(users);
        }
        ...
        public async Task<IActionResult> EditUser(string id)
        {
            ...
            if (user == null)
            {
                ViewBag.ErrorMessage = $"User whith Id = {id} cannot be found";
        ...
        public async Task<IActionResult> EditUser(EditUserViewModel model, string id)
        {
            //ViewBag.ChiNhanhs = unitOfWork.chiNhanhRepository.GetAll();
            //ViewBag.VanPhongs = unitOfWork.vanPhongRepository.GetAll();
            model.ChiNhanhs = unitOfWork.chiNhanhRepository.GetAll();
            model.VanPhongs = unitOfWork.vanPhongRepository.GetAll();
            ...
            else
            {
                ...
                user.PhongBan = model.PhongBan;
                user.Khoi = model.Khoi;
                user.ChiNhanhId = model.ChiNhanhId;
                user.VanPhong = model.VanPhong;
